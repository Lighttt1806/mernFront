...
const HorizontalCardProduct = ({category, heading}) => {
  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
            ...
            <h2 data-aos-duration="1500" data-aos="fade-up" className='text-3xl mt-3 font-light py-4'>{heading}</h2>

                
           <div data-aos-duration="2000" data-aos="fade-up" className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
